...
#set the total concentration of anions to 0.1M + the concentrations of protons
electrolyte_reactions+=[{'constraints':{'counter_ion_concentration':0.1*1000}}]
