...
#    'CH4':          {'reaction':                'CO + 6 H+ + 6 e- -> CH4 + 1 H2O'}, #methane
#    'CH3CH2OH':     {   'reaction':             '2 CO + 10 H+ + 10 e- -> CH3CH2OH + 2 H2O'},
#    'CH2O':         {   'reaction':             'CO + 2 H+ + 2 e- -> CH2O'}}

    ###alkaline
    'H2':           {   'reaction':            '2 H2O + 2 e- -> H2 + 2 OH-'},
    'CH4':          {   'reaction':            'CO + 5 H2O + 6 e- -> CH4 + 6 OH-'},
    'CH3CH2OH':     {   'reaction':            '2 CO + 7 H2O + 8 e- -> CH3CH2OH + 8 OH-'},
    'CH2O':         {   'reaction':            'CO + 2 H2O + 2 e- -> CH2O + 2 OH-'}}
